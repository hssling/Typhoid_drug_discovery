"""
Generate REVISED DOCX Manuscript for Typhoid HDT Pipeline
...
def create_revised_manuscript():
    ...
    # TABLE 2 - Enhanced with cost/safety
    doc.add_paragraph()
    ...
    t3_note.add_run('*p<0.05, **p<0.01 versus autophagy pathway (Mann-Whitney U test). Significance indicates difference from highest-scoring pathway.').italic = True
    ...
    # ==========================================
    # REFERENCES - Vancouver with PMIDs
    # ==========================================
    doc.add_heading('REFERENCES', level=1)
    
    references = [
        'GBD 2017 Typhoid and Paratyphoid Collaborators. The global burden of typhoid and paratyphoid fevers: a systematic analysis for the Global Burden of Disease Study 2017. Lancet Infect Dis 2019;19(4):369-381. PMID: 30792131',
        'Antillón M, Warren JL, Crawford FW, et al. The burden of typhoid fever in low- and middle-income countries: A meta-regression approach. PLoS Negl Trop Dis 2017;11(2):e0005376. PMID: 28222095',
        'John J, Van Aart CJ, Grassly NC. The burden of typhoid and paratyphoid in India: systematic review and meta-analysis. PLoS Negl Trop Dis 2016;10(8):e0004616. PMID: 27533097',
        'Mogasale V, Maskery B, Ochiai RL, et al. Burden of typhoid fever in low-income and middle-income countries: a systematic, literature-based update with risk-factor adjustment. Lancet Glob Health 2014;2(10):e570-580. PMID: 25304633',
        'Carey ME, MacWright WR, Im J, et al. The growing threat of antimicrobial-resistant enteric fever. Curr Opin Gastroenterol 2021;37(1):22-30. PMID: 33148973',
        'Wong VK, Baker S, Pickard DJ, et al. Phylogeographical analysis of the dominant multidrug-resistant H58 clade of Salmonella Typhi identifies inter- and intracontinental transmission events. Nat Genet 2015;47(6):632-639. PMID: 25961941',
        'Kariuki S, Gordon MA, Feasey N, Parry CM. Antimicrobial resistance and management of invasive Salmonella disease. Vaccine 2015;33 Suppl 3:C21-29. PMID: 25912288',
        'Klemm EJ, Shakoor S, Page AJ, et al. Emergence of an extensively drug-resistant Salmonella enterica serovar Typhi clone harboring a promiscuous plasmid encoding resistance to fluoroquinolones and third-generation cephalosporins. mBio 2018;9(1):e00105-18. PMID: 29463654',
        ...
        'Figueira R, Holden DW. Functions of the Salmonella pathogenicity island 2 (SPI-2) type III secretion system effectors. Microbiology (Reading) 2012;158(Pt 5):1147-1161. PMID: 22422755',
        'Gunn JS, Marshall JM, Baker S, et al. Salmonella chronic carriage: epidemiology, diagnosis, and gallbladder persistence. Trends Microbiol 2014;22(11):648-655. PMID: 25175700',
        ...
        'RECOVERY Collaborative Group. Tocilizumab in patients admitted to hospital with COVID-19 (RECOVERY): a randomised, controlled, open-label, platform trial. Lancet 2021;397(10285):1637-1645. PMID: 33933206',
        ...
        'Barrett T, Wilhite SE, Ledoux P, et al. NCBI GEO: archive for functional genomics data sets--update. Nucleic Acids Res 2013;41(Database issue):D991-995. PMID: 23193258',
        ...
        'Eriksson S, Lucchini S, Thompson A, et al. Unravelling the biology of macrophage infection by gene expression profiling of intracellular Salmonella. Mol Microbiol 2003;47(1):103-118. PMID: 12492857',
        'Blohmke CJ, Darton TC, Jones C, et al. Interferon-driven alterations of the host\'s amino acid metabolism in the pathogenesis of typhoid fever. J Exp Med 2016;213(6):1061-1077. PMID: 27217536',
        ...
        'Gomes LC, Dikic I. Autophagy in antimicrobial immunity. Mol Cell 2014;54(2):224-233. PMID: 24766886',
    ...
    print('Addresses all reviewer comments')

if __name__ == '__main__':
    create_revised_manuscript()
